(function ($) {
    ...
    $(function () {
        ...
        $('#ResetToDefaults').click(function (e) {
            abp.message.confirm(l('AreYouSureToResetToDefault'))
                .then(function (confirmed) {
                    if (confirmed) {
                        polaris.abp.themeManagement.services.brandSetting.reset().then(function () {
        ...
        $("#BrandSettingForm").on('submit', function (event) {
            ...
            polaris.abp.themeManagement.services.brandSetting.update(form).then(function (result) {
