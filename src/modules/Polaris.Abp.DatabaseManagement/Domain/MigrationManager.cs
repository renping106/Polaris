...
namespace Polaris.Abp.DatabaseManagement.Domain
{
    ...
    {
        public static readonly string MigrationNamespace = "Polaris.Abp.EntityFrameworkCore.Migrations";
        public static readonly string MigrationClassName = "PolarisDbContextModelSnapshot";
        ...
        private readonly List<PolarisModelHistory> _snapshots = new List<PolarisModelHistory>();
